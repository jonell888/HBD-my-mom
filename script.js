let select = s => document.querySelector(s),
    ...
    allHappyBirthday = gsap.utils.toArray('#happyBirthdayGroup path'),
...
tl.add('step0', '+=2')
    ...
    .to('.happyBirthdayMask', {
        x: '+=548',
        ease: 'expo.inOut'
    }, 'step1')
    .from(allHappyBirthday, {
        x: 50,
...
// Gradually show the birthday image
